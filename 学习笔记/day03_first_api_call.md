...
>
> 📚 所属阶段：**第一阶段 · 基础与提示词工程**（见 [`plan.md`](../规划文档/plan.md)）｜ 配套：[30 天路线](../规划文档/llm_app_30_day_roadmap.md) · Day 3
>
...
- [一、API 调用基础概念](#一api-调用基础概念)
  - [1.1 什么是 API](#11-什么是-api)
  - [1.2 HTTP 请求基础](#12-http-请求基础)
  - [1.3 JSON 数据格式](#13-json-数据格式)
- [二、API Key 管理](#二api-key-管理)
  - [2.1 什么是 API Key](#21-什么是-api-key)
  - [2.2 获取 API Key](#22-获取-api-key)
  - [2.3 安全存储 API Key](#23-安全存储-api-key)
- [三、调用大模型 API](#三调用大模型-api)
  - [3.1 使用 requests 库调用](#31-使用-requests-库调用)
  - [3.2 使用官方 SDK 调用](#32-使用官方-sdk-调用)
- [四、封装可复用的 LLM 客户端](#四封装可复用的-llm-客户端)
  - [4.1 基础版本](#41-基础版本)
  - [4.2 添加重试和错误处理](#42-添加重试和错误处理)
- [五、实战练习](#五实战练习)
  - [5.1 创建项目结构](#51-创建项目结构)
  - [5.2 配置文件](#52-配置文件)
  - [5.3 完整示例程序](#53-完整示例程序)
- [六、常见问题排查](#六常见问题排查)
  - [6.1 常见错误及解决](#61-常见错误及解决)
  - [6.2 调试技巧](#62-调试技巧)
  - [6.3 代理设置](#63-代理设置)
- [七、Day 3 知识速查](#七day-3-知识速查)
- [八、实践任务](#八实践任务)
