...
>
> 🧭 导航：[← Day 6 · 信息抽取工具](day06_info_extractor.md) [→ Day 8 · 结构化输出](day08_structured_output.md)
...
| 参数 | 默认值 | 说明 |
|------|--------|------|
| `temperature` | 1.0（因 API 而异）| 0=确定，>1=随机；抽取用 0，摘要用 0.1，聊天用 0.7；**建议在代码中显式传入，不依赖默认值** |
