...
>
> 📚 所属阶段：**第一阶段 · 基础与提示词工程**（见 [`plan.md`](../规划文档/plan.md)）｜ 配套：[30 天路线](../规划文档/llm_app_30_day_roadmap.md) · Day 2
>
...
- [一、为什么需要 Python](#一为什么需要-python)
- [二、环境搭建](#二环境搭建)
  - [2.1 安装 Python](#21-安装-python)
  - [2.2 虚拟环境](#22-虚拟环境)
  - [2.3 包管理工具 pip](#23-包管理工具-pip)
- [三、Python 基础语法](#三python-基础语法)
  - [3.1 变量与数据类型](#31-变量与数据类型)
  - [3.2 列表（List）](#32-列表list)
  - [3.3 字典（Dict）](#33-字典dict)
  - [3.4 函数](#34-函数)
  - [3.5 类（Class）](#35-类class)
- [四、文件操作](#四文件操作)
  - [4.1 文件读取](#41-文件读取)
  - [4.2 文件写入](#42-文件写入)
  - [4.3 文件模式速查](#43-文件模式速查)
  - [4.4 文件路径处理](#44-文件路径处理)
- [五、异常处理](#五异常处理)
  - [5.1 基本语法](#51-基本语法)
  - [5.2 完整结构](#52-完整结构)
  - [5.3 常见异常类型](#53-常见异常类型)
  - [5.4 主动抛出异常](#54-主动抛出异常)
  - [5.5 自定义异常](#55-自定义异常)
  - [5.6 最佳实践](#56-最佳实践)
- [六、Day 2 实践任务](#六day-2-实践任务)
- [七、常见问题](#七常见问题)
- [八、Day 2 知识速查表](#八day-2-知识速查表)
